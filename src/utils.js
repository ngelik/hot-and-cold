...
const MAJOR_CITIES = [
  ...
  { name: "Kazan", country: "Russia", lat: 55.7887, lon: 49.1221, region: REGIONS.EUROPE },
  { name: "Nizhny Novgorod", country: "Russia", lat: 56.2965, lon: 43.9361, region: REGIONS.EUROPE },
  { name: "Rostov-on-Don", country: "Russia", lat: 47.2357, lon: 39.7015, region: REGIONS.EUROPE },
  { name: "Volgograd", country: "Russia", lat: 48.7080, lon: 44.5133, region: REGIONS.EUROPE },
  { name: "Voronezh", country: "Russia", lat: 51.6720, lon: 39.1843, region: REGIONS.EUROPE },
  { name: "Perm", country: "Russia", lat: 58.0105, lon: 56.2502, region: REGIONS.EUROPE },
  { name: "Ufa", country: "Russia", lat: 54.7355, lon: 55.9910, region: REGIONS.EUROPE },
  { name: "Samara", country: "Russia", lat: 53.2001, lon: 50.1500, region: REGIONS.EUROPE },
...
function getRegionExtremes() {
  ...
  MAJOR_CITIES.forEach(city => {
    ...
    // Check northernmost (potentially coldest)
    ...
    // Check southernmost (potentially hottest in northern hemisphere, coldest in southern)
...
console.log('Regional Temperature Extremes (based on latitude):');
extremes.forEach(({ region, coldest, hottest }) => {
  console.log(`\n${region}:`);
  console.log(`Coldest: ${coldest.name}, ${coldest.country} (${coldest.lat.toFixed(2)}°)`);
  console.log(`Hottest: ${hottest.name}, ${hottest.country} (${hottest.lat.toFixed(2)}°)`);
}); 